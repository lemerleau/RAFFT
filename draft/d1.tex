...
\begin{figure}[!ht]
  ...
  \begin{tikzpicture}
    \node (s11) at (0cm,3cm) {\subfloat[RAFFT]{\includegraphics[scale=0.02]{./img/illed_img/srp_Heli_fft.png}}};
    \node (s12) at (3cm,3cm) {\subfloat[MFE]{\includegraphics[scale=0.02]{./img/illed_img/srp_Heli_mfe.png}}};
    \node (s13) at (0cm,0cm) {\subfloat[ML]{\includegraphics[scale=0.05]{./img/illed_img/srp_Heli_mx.png}}};
    \node (s14) at (3cm,0cm) {\subfloat[WT]{\includegraphics[scale=0.05]{./img/illed_img/srp_Heli_wt.png}}};
  \end{tikzpicture}
  }
  \subfloat[\texttt{srp\_Meth.mari.\_CP000745}]{
  \begin{tikzpicture}
    \node (s11) at (0cm,3cm) {\subfloat[RAFFT]{\includegraphics[scale=0.05]{./img/illed_img/srp_Meth_fft.png}}};
    \node (s12) at (3cm,3cm) {\subfloat[MFE]{\includegraphics[scale=0.05]{./img/illed_img/srp_Meth_mfe.png}}};
    \node (s13) at (0cm,0cm) {\subfloat[ML]{\includegraphics[scale=0.05]{./img/illed_img/srp_Meth_mx.png}}};
    \node (s14) at (3cm,0cm) {\subfloat[WT]{\includegraphics[scale=0.05]{./img/illed_img/srp_Meth_wt.png}}};
  \end{tikzpicture}
  }\\
  \subfloat[\texttt{tmRNA\_Cyan.mero.\_AY286123\_1\-236}]{
  \begin{tikzpicture}
    \node (s11) at (0cm,0cm) {\subfloat[RAFFT]{\includegraphics[scale=0.03]{./img/illed_img/tmRNA_Cyan_fft.png}}};
    \node (s12) at (3cm,0cm) {\subfloat[MFE]{\includegraphics[scale=0.03]{./img/illed_img/tmRNA_Cyan_mfe.png}}};
    \node (s13) at (6cm,0cm) {\subfloat[ML]{\includegraphics[scale=0.05]{./img/illed_img/tmRNA_Cyan_mx.png}}};
    \node (s14) at (9cm,0cm) {\subfloat[WT]{\includegraphics[scale=0.05]{./img/illed_img/tmRNA_Cyan_wt.png}}};
  \end{tikzpicture}
  }
...
\begin{figure}[!h]
  \begin{tikzpicture}
    \node (s0) at (0cm,4cm) {\includegraphics[scale=0.04]{img/frame_shift/step_0.png}};

    \node (s11) at (2.5cm,8cm) {\includegraphics[scale=0.04]{img/frame_shift/step_1_0.png}};
    \node (s12) at (2.5cm,6cm) {\includegraphics[scale=0.03]{img/frame_shift/step_1_1.png}};
    \node (s13) at (2.5cm,4cm) {\includegraphics[scale=0.03]{img/frame_shift/step_1_2.png}};
    \node (s14) at (2.5cm,2cm) {\includegraphics[scale=0.04]{img/frame_shift/step_1_3.png}};
    \node (s15) at (2.5cm,0cm) {\includegraphics[scale=0.04]{img/frame_shift/step_1_4.png}};

    \node (s21) at (6cm,8cm) {\includegraphics[scale=0.04]{img/frame_shift/step_2_0.png}};
    \node (s22) at (5.6cm,6cm) {\includegraphics[scale=0.04]{img/frame_shift/step_2_1.png}};
    \node (s23) at (6cm,4cm) {\includegraphics[scale=0.04]{img/frame_shift/step_2_2.png}};
    \node (s24) at (5.7cm,2cm) {\includegraphics[scale=0.04]{img/frame_shift/step_2_3.png}};
    \node (s25) at (5.6cm,0cm) {\includegraphics[scale=0.05]{img/frame_shift/step_2_4.png}};

    \node (s31) at (9cm,8cm) {\includegraphics[scale=0.04]{img/frame_shift/step_3_0.png}};
    \node (s32) at (9cm,6cm) {\includegraphics[scale=0.04]{img/frame_shift/step_3_1.png}};
    \node (s33) at (9cm,4cm) {\includegraphics[scale=0.04]{img/frame_shift/step_3_2.png}};
    \node (s34) at (9cm,2cm) {\includegraphics[scale=0.04]{img/frame_shift/step_3_3.png}};
    \node (s35) at (8.8cm,0cm) {\includegraphics[scale=0.04]{img/frame_shift/step_3_4.png}};

    \node (wt) at  (13cm,2cm) {\includegraphics[scale=0.1]{img/frame_shift/wt.png}};
    \node (wtn) at  (11cm,1cm) {WT};
    \node (mfe) at (13cm,6cm) {\includegraphics[scale=0.1]{img/frame_shift/mfe.png}};
    \node (mfen) at  (11cm,6cm) {MFE};

    \draw (s0) edge[pil,->,thick,bend,right] (s11);
    \draw (s0) edge[pil,->,thick,bend,right] (s12);
    \draw (s0) edge[pil,->,thick,bend,right] (s13);
    \draw (s0) edge[pil,->,thick,bend,right] (s14);
    \draw (s0) edge[pil,->,thick,bend,right] (s15);

    \draw (s13) edge[pil,->,thick,bend,right] (s23);
    \draw (s11) edge[pil,->,thick,bend,right] (s21);
    \draw (s11) edge[pil,->,thick,bend,right] (s22);
    \draw (s11) edge[pil,->,thick,bend,right] (s24);
    \draw (s11) edge[pil,->,thick,bend,right] (s25);

    \draw (s21) edge[pil,->,thick,bend,right] (s31);
    \draw (s21) edge[pil,->,thick,bend,right] (s32);
    \draw (s21) edge[pil,->,thick,bend,right] (s33);
    \draw (s21) edge[pil,->,thick,bend,right] (s34);
    \draw (s21) edge[pil,->,thick,bend,right] (s35);
    \draw (s24) edge[pil,->,thick,bend,right] (s34);
