#+TITLE: An RNA fast-folding path heuristic
#+OPTIONS: H:4 toc:nil
...
#+attr_latex: :scale 0.85 :placement [h!]
#+name: landscape
#+caption: *Landscape built from 300 parallel trajectories.*
...
#+attr_latex: :scale 0.85 :placement [h!]
#+name: landscape
#+caption: *Folding kinetic derived from the fast-folding scheme with 300 saved structures.*
file:img/kinetic_comb.png
